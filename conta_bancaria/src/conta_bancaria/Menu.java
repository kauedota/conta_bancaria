...
public class Menu {
	...
	public static void cadastrarConta() {
		...
		leia.skip("\\R?"); // limpa o buffer se tiver sobrado ENTER de antes
	...
	public static void atualizarConta() {
		...
		if (conta.isPresent()) {
			...
			System.out.printf(
					"Agência atual: %d%nDigite o número da nova agência (Pressione ENTER para manter o valor atual)",
					agencia);
			...
			System.out.printf(
					"Titular atual: %s%nDigite o nome do novo tiular (Pressione ENTER para manter o valor atual)",
					titular);
